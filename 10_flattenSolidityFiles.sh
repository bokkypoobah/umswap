...
#
echo "\$ npx hardhat flatten contracts/SimpleERC721.sol > flattened/SimpleERC721_flattened.sol ..."
npx hardhat flatten contracts/SimpleERC721.sol > flattened/SimpleERC721_flattened.sol
